import { Euro, Wrench, Clock, TrendingUp } from "lucide-react";
...
export function CustomerStats({ totalRepairs, totalSpent, avgRepairTime, completionRate }: CustomerStatsProps) {
  return (
    <div className="grid gap-4 md:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{avgRepairTime} giorni</div>
        </CardContent>
      </Card>
