      ...
      >
        ...
        >
          ...
          <motion.span
            ...
            transition={{ type: "spring", stiffness: 350, damping: 12, delay: 0.12 }}
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="bg-white/[0.08] backdrop-blur-md rounded-2xl px-3 py-1.5 max-w-[85%] border border-white/[0.06]"
      >
