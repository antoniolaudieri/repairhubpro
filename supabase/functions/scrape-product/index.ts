        ...
        extract: {
          schema: {
            ...
            properties: {
              ...
              price: { type: 'number', description: 'The MAIN product selling price (the large price near Add to Cart button). IGNORE: shipping costs, monthly payments, "was" prices, coupon amounts, or any price under 20 euros for electronics. The main price for electronics is usually 50-2000 euros.' },
              currency: { type: 'string', description: 'Currency symbol (€, $, £) or code (EUR, USD)' },
              imageUrl: { type: 'string', description: 'The main high-resolution product image URL. For Amazon, look for images from "m.media-amazon.com/images/I/" with large size.' },
          ...
          prompt: 'Extract product information from this e-commerce page. CRITICAL FOR PRICE: Find the MAIN selling price displayed prominently near the "Add to Cart" or "Buy Now" button. This is usually a large number (for electronics typically 50-2000 euros). DO NOT extract shipping costs (usually 5-15 euros), monthly payment amounts, or "was/before" prices. The main price is the current selling price of the product itself.',
        },
